<%@ Page Title="" Language="C#" MasterPageFile="~/Index.master" AutoEventWireup="true" CodeFile="VerPostulaciones.aspx.cs" Inherits="Vistas_profesor_VerPostulaciones" %>
            ...
            <asp:GridView ID="GridView"
                ...
                <Columns>
                    ...
                    <asp:TemplateField Visible="true">
                        <ItemTemplate>
                            <div class="text-center">
                                <asp:LinkButton runat="server" CommandName="select" ID="lnk_Select" class="btn btn-outline-primary" Text="Seleccionar Postulante" />
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
